<x-app-layout>
    ...
    <div class="pt-24">
        ...
        <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
            ...
            <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
                <p class="uppercase tracking-loose w-full">Our mission goals</p>
                <h1 class="my-4 text-5xl font-bold leading-tight">Main Message to sell yourself!</h1>
                <p class="leading-normal text-2xl mb-8">Sub message, not too long and not too short. Make it just right!</p>
                @include('components.donate-button')
            </div>
            <!--Right Col-->
            <div class="w-full md:w-3/5 py-6 text-center">
                <img class="w-full md:w-4/5 z-50" src="{{ asset('img/kids_circle_p.png') }}" alt="">
            </div>
    ...
    <section class="bg-white border-b py-8">
        <div class="container max-w-5xl mx-auto m-8">
            ...
            @include('components.viewbox-left')

            @include('components.viewbox-right')
